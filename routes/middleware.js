...
exports.initLocals = function(req, res, next) {
	...
	locals.navLinks = [
		...
		{ label: '社交活动',		key: 'meetups',		href: '/meetups' },
		{ label: '项目众筹',		key: 'projects',		href: '/projects' },
		{ label: 'NEXT成员',		key: 'members',		href: '/members' },
		{ label: '合作伙伴',		key: 'organisations',		href: '/organisations' }
...
exports.requireUserViewMember = function(req, res, next) {
	if (!req.user) {
		req.flash('error', 'Please sign in to view member detail');
		res.redirect('/signin');
	} else {
		next();
	}
