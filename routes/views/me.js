...
exports = module.exports = function(req, res) {
	...
	locals.section = 'me';
	locals.page.title = 'Settings - NEXT Startup Club';
	...
	view.on('post', { action: 'profile.details' }, function(next) {
		...
		req.user.getUpdateHandler(req).process(req.body, {
			fields: 'name, email, notifications.meetups, notifications.posts,wechat,education,' +
			'website,career, isPublic, bio, photo,company,title,startupDescription,projectUrl,startupName,' +
