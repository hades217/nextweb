...
Meetup.add({
	...
	startDate: { type: Types.Datetime, required: false, initial: true, index: true, width: 'short', note: 'e.g. 2016-07-15 / 6:00pm' },
	endDate: { type: Types.Datetime, required: false, initial: true, index: true, width: 'short', note: 'e.g. 2016-07-15 / 9:00pm' },
