...
User.add({
	...
	projects: { type: Types.Relationship, ref: 'Projects' },
	...
	education: { type: Types.Select, options:"TAFE/Business College, Bachelor Degree, Postgraduate Degree & MBA/Master , PHD/Doctoral Degree", default: "Bachelor Degree" },
	...
	isAdmin: { type: Boolean, label: 'Can Admin NEXT Startup Club' },
...
User.schema.virtual('avatarUrl').get(function() {
	...
	if (this.gravatar) return 'http://res.cloudinary.com/diliv19aw/image/upload/v1472911481/avatar_qmy8m2.png';
});
...
User.schema.methods.resetPassword = function(callback) {
	...
	user.save(function(err) {
		...
		new keystone.Email('forgotten-password').send({
			...
			subject: 'Reset your NEXT Startup Club Password',
			to: user.email,
			from: {
