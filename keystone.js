...
keystone.init({
	...
	'auth': true,
	'user model': 'User',
	'cookie secret': process.env.COOKIE_SECRET || 'nex',
...
keystone.set('email locals', {
	utils: keystone.utils,
	host: (function() {
		if (keystone.get('env') === 'staging') return 'http://nexstartup.org/';
		if (keystone.get('env') === 'production') return 'http://nexstartup.org/';
...
keystone.set('nav', {
	...
	'members': ['users', 'organisations','projects'],
